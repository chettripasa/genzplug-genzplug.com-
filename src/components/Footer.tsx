      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">GenZPlug</h3>
            <p className="text-gray-300 mb-4">
              A modern e-commerce platform built with Next.js, MongoDB, and Stripe. 
              Experience seamless shopping with secure payments and real-time inventory management.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=books" className="text-gray-300 hover:text-white">
                  Books
                </Link>
              </li>
            </ul>
